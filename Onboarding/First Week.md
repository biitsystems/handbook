...
Hey! Welcome to the biits team, we’re so excited to have you with us. We’re hoping you’re going to learn a lot working here and that we’ll learn a lot from you. But first, this document will help you start figuring out how biits works and how we work together.

At biits, we’re trying to build an inclusive and value-driven organization, so you’ll find that a lot of our policies differ from the norm at other companies. If you have any questions about why we do things a certain way, or have a suggestion about how we can do anything better, please let us know (or just write comments in the documents -- you should already have comment access to everything in the biits handbook!).

## Your First Day

Hopefully by the time you’re actually starting at biits, you’ve already finished filling out the paperwork and you’ve showed up to a desk with a new computer and the accessories that fit your work-style. Today is all about getting you set up and making sure you’re ready to go.

**The goal for today is for you to publish _something_ live.** If you’re a designer, that could be a color change for a button. If you’re a developer, it might be fixing a missing semicolon. It could be a tweet from the biits account or a blog post, a support response or an infographic. Whatever you’ll be doing at biits, we want you to ship something small today.
...
## The Basics about biits

**biits is a values-driven company.** Hopefully you heard about this a lot during your interview process, but we take our values really seriously at biits and they guide the decisions we make here. You can read more about the [biits Values](https://github.com/biits/handbook/blob/master/biits%20Values.md), but the short versions are:
...
For now, biits operates as a single team where everyone is working towards company-level goals. Since we’re still small, there’s not too much overhead in keeping up with everyone. There are still engineering-specific meetings, and marketing conversations that happen separately. But when we set our goals, we all think directly about how we contribute to the company goals. You’ll get to work with everyone at biits in some capacity, and dip your fingers into all different kinds of thinking.
